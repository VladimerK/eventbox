...
const Contact = () => {
 ...
 axios.post('http://localhost:3000/api/email',{email})
  ...
  return (
    ...
    <div className='max-w-[1240px] m-auto p-4 h-screen' id='contactus'>
<h1 className='text-2xl font-bold text-center p-4'>Lets do amazing Stuff together</h1>
<form className="rounded-lg shadow-xl flex flex-col px-8 py-8 bg-white dark:bg-blue-500">
      ...
      <div className="flex flex-row items-center justify-start">
        <button onClick={SendMail} className="px-10 mt-8 py-2 bg-[#130F49] text-gray-50 font-light rounded-md text-lg flex flex-row items-center">
          Send
